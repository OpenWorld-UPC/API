...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    private String parseTokenFrom(HttpServletRequest request){
        ...
        if(StringUtils.hasText(authorizationHandler) && authorizationHandler.startsWith("Bearer"))
            return new LinkedList<>(Arrays.asList(authorizationHandler.split(" "))).getLast();
        return null;
    }
